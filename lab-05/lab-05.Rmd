...
`Shapefile` is a geospatial vector data format developed by [Esri](https://www.esri.com/en-us/home). The annoying point of `Shapefile` is a set of at least 3–7 separate files that must all stay together.
...
Geographic Coordinate Systems (GCS) use degrees of **latitude** and **longitude** and sometimes also a height value to describe a location on the earth’s surface. The most popular is called [WGS 84](https://earth-info.nga.mil/index.php?dir=wgs84&action=wgs84) (EPSG:
