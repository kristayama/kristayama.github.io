...
skim(data)
```
According to the [Data Dictionary and Technical Notes](https://www.fhfa.gov/document/NMDB-Aggregate-Statistics-Data-Dictionary-Technical-Notes.pdf), the dataset includes two analysis variables, VALUE1 and VALUE2, where VALUE1
