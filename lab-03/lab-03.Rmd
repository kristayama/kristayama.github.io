...
```
The first bar chart shows that mortgage activity varies widely across states, with a few states having much higher loan counts than others. The second bar chart displays total loan balances by state, following a similar pattern where states with more loans also have larger balances. Finally, the scatterplot shows a clear positive relationship between mortgage count and loan balance, meaning states with more mortgages generally hold higher total loan amounts.
